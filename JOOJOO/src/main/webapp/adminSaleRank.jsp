                        ...
                        <tr>
                            <td>
                                ...
                                <c:if test="${v.mID ne null}">
                                    <button type="button" id="myButton" class="btn btn-primarymid"
                                            data-bs-toggle="modal" data-bs-target="#modalCenter" data-mid="${v.mID}">
                                            ${v.mID}
                                    </button>
                                    <input type="hidden" id="hiddenInput" style="border: none; background: none;"
                                           value=${ v.mID }>
                                </c:if>
                            </td>
