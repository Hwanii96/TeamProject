                ...
                <div class="categoryContainer">
                    <div class="category" style="margin-left: auto;">
                        <div class="alcohol" style="padding-top: 20px;">
                            <a href="searchFilter.do?pCategory=과실주"> <img alt=""
                                                                          src="assets/img/store/icon_gwashilju.png">
                                <br> <span>과실주</span>
                            </a>
                        </div>

                        <div class="alcohol" style="padding-top: 20px;">
                            <a href="searchFilter.do?pCategory=증류주"> <img alt=""
                                                                          src="assets/img/store/icon_jeungryuju.png">
                                <br> <span>증류주</span>
                            </a>
                        </div>

                        <div class="alcohol" style="padding-top: 20px;">
                            <a href="searchFilter.do?pCategory=청주"> <img alt=""
                                                                         src="assets/img/store/icon_cheongju.png"> <br>
                                <span>청주</span>
                            </a>
                        </div>

                        <div class="alcohol" style="padding-top: 20px;">
                            <a href="searchFilter.do?pCategory=탁주"> <img alt="" src="assets/img/store/icon_takju.png">
                                <br> <span>탁주</span>
                            </a>
                        </div>
                    </div>
