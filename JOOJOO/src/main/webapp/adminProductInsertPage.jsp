            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form action="adminProductInsert.do" id="formAccountSettings" method="POST"
                                  enctype="multipart/form-data" onsubmit="return validateForm(this);">

                                <div class="d-flex align-items-start align-items-sm-center gap-4">

                                    <img alt="" src="assets/img/products/defaultDetail.jpg" class="d-block rounded"
                                         height="240" width="150" id="uploadedAvatar1"> <img alt=""
                                                                                             src="assets/img/products/default.jpg"
                                                                                             class="d-block rounded"
                                                                                             height="240" width="150"
                                                                                             id="uploadedAvatar2">
                                </div>
                                <label for="formFile" class="form-label">상품 이미지 등록</label> <input class="form-control"
                                                                                                  type="file"
                                                                                                  id="formFile"
                                                                                                  name="fileUpload1"
                                                                                                  onchange="thumbnail1(this);"
                                                                                                  required/> <input
                                    class="form-control" type="file" id="formFile" name="fileUpload2"
                                    onchange="thumbnail2(this);" required/> <br>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="firstName" class="form-label">상품 명</label> <input
                                            ...
                                            name="pName" value="${pdata.pName }" placeholder="상품명을 입력하세요." autofocus
                                            required/>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="lastName" class="form-label">상품 가격</label> <input
                                            class="form-control" type="text" name="pPrice"
                                            id="lastName" value="${pdata.pPrice }" placeholder="상품 가격을 입력하세요."
                                            oninput="validateInputPrice(this)" required/>
                                        <div id="errorMessage" style="color: red;"></div>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="email" class="form-label">상품 재고</label> <input
                                            class="form-control" type="text" id="email" name="pCnt"
                                            value="${pdata.pCnt }" placeholder="상품 재고를 입력하세요."
                                            oninput="validateInputCnt(this, 'cntError')" required/>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="organization" class="form-label">도수</label> <input
                                            ...
                                            name="pAlcohol" value="${pdata.pAlcohol }"
                                            placeholder="0.1~40.0의 숫자를 입력하세요."
                                            oninput="validateInput(this, 'alcoholError')" required/>
                                        <div id="alcoholError" style="color: red;"></div>
                                    </div>


                                    <div class="mb-3 col-md-6">
                                        <label class="form-label" for="country">카테고리</label> <select id="country"
                                                                                                     name="pCategory"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="language" class="form-label">신맛</label> <select id="language"
                                                                                                    name="pSour"
                                                                                                    class="select2 form-select">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="timeZones" class="form-label">단맛</label> <select id="timeZones"
                                                                                                     name="pSweet"
                                                                                                     class="select2 form-select">
                                        <option value="약">약</option>
                                        <option value="중">중</option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="currency" class="form-label">탄산</label> <select id="currency"
                                                                                                    name="pSparkle"
                                                                                                    class="select2 form-select">
                                        <option value="약">약</option>
                                        <option value="중">중</option>
