                            ...
                            <div class="row">
                                ...
                                <c:forEach var="orderEntry" items="${orderDatas}">
                                    <div style="border: 1px solid #ccc; margin-bottom: 30px; background-color: #fdfdfd; border-radius: 5px;">
                                        ...
                                        <br>
                                        <h5 class="mb-0" style="color: #696cff; padding-bottom: 10px;"><strong>주문
                                            정보</strong></h5>
                                        <p class="mb-0">주문 날짜: ${orderEntry.key.oDate}</p>
                                        <p class="mb-0">총 구매 가격: <fmt:formatNumber type="number"
                                                                                   value="${orderEntry.key.oPrice}"/>원</p>
                                        <p class="mb-0">주문 상태: ${orderEntry.key.oState}</p>
                                        <p class="mb-0">주문 주소지: ${orderEntry.key.oAddress}</p>
                                        <hr>

                                        <h5 class="mb-0" style="color: #696cff; padding-bottom: 10px;"><strong>상품
                                            정보</strong></h5>
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach var="value" items="${orderEntry.value}">
                                                <tr>
                                                    ...
                                                    <td class="flexProperty"><fmt:formatNumber type="number"
                                                                                               value="${value.pPrice}"/>원
                                                    </td>
                                                    <td class="flexProperty"><fmt:formatNumber type="number"
                                                                                               value="${value.odCnt}"/>개
                                                    </td>
