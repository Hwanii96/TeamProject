            ...
            <div class="box">
                ...
                <div class="product-content">
                    ...
                    <div class="rating_box">
                        <div class="rating">
                            ★★★★★ <span class="rating_star" style="width: ${pdata.pStarAvg * 20}%;">★★★★★</span> <input
                                type="range" name="bStar" value="0" step="0.05" min="1" max="5">
                        </div>
                    </div>
                ...
                <div class="detail">
                    ...
                    <div id="detailbox">
                        <c:forEach var="v" items="${bdatas}">
                            <div class="reviewBox">
                                <p class="name">${v.mName}
                                    <span><fmt:formatDate value="${v.bDate}" pattern="yyyy-MM-dd"/></span>
                                </p>
                                <p>별점: ${v.bStar}</p>
                                <p>${v.bContent}</p>
                                <c:if test="${not empty mID and v.mID ne mID}">
                                    <c:if test="${v.check eq false}">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                ...
                                                onclick="openModalWithBNum(this, ${v.bNum}, ${pdata.pNum} )"
                                                id="reportButton_${v.bNum}">신고
                                        </button>
                                    </c:if>
                                    <c:if test="${v.check eq true}">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#basicModal"
                                                onclick="openModalWithBNum(this, ${v.bNum}, ${pdata.pNum} )"
                                                id="reportButton_${v.bNum}" disabled="disabled">신고
                                        </button>
                                    </c:if>
                                </c:if>
                            </div>
