...
public class LoginController {
    ...
    @ResponseBody
    public String recommendationVaildity(MemberVO mVO, ObjectMapper objectMapper) throws JsonProcessingException {
        ...
        if (mVO != null) {   //  유효한 회원이 있다면,
            String jdata = objectMapper.writeValueAsString(mVO);
            return jdata;
        }
