...
public class DeclarationDAO2 {
    ...
    static final String SQL_INSERT
            = "INSERT INTO DECLARATION (DNUM, BNUM, MID) VALUES ((SELECT NVL(MAX(DNUM),0) + 1 FROM DECLARATION),?,?)";
    ...
    static final String SQL_SELECTONE
            = "SELECT B.MID, B.BCONTENT, B.BSTAR, B.BDATE, B.MNAME, D.DNUM, D.BNUM, D.MID AS DMID , D.DDATE, P.PNAME, P.PIMAGE"
