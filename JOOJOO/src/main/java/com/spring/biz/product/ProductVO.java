...
public class ProductVO { // 상품 / 주류
    ...
    static String FilePath = "C:\\Users\\dhfg0\\Desktop\\IntelliJ\\IJ\\IdeaProjects\\JOOJOO\\src\\main\\webapp\\assets\\img\\products\\";
    ...
    public String toString() {
        ...
        return "상품 : " + this.pName + " / 가격 : " + this.pPrice + " / 별점 평균 : " + this.pStarAvg + " / 상품 개수 : "
                + this.pCnt + " / 카테고리 : " + this.pCategory + " / 알콜 도수 : " + this.pAlcohol + " / 단맛 : " + this.pSweet
    ...
    public boolean equals(Object obj) {
        ...
        // Object 타입의 매개변수 obj를 ProductVO 타입으로 다운 캐스팅 == 다형성
