                            ...
                            >
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <option value="과실주"
                                                <c:if test="${pdata.pCategory eq '과실주'}">selected</c:if>>과실주
                                        </option>

                                        <option value="증류주"
                                                <c:if test="${pdata.pCategory eq '증류주'}">selected</c:if>>증류주
                                        </option>

                                        <option value="청주"
                                                <c:if test="${pdata.pCategory eq '청주'}">selected</c:if>>청주
                                        </option>

                                        <option value="탁주"
                                                <c:if test="${pdata.pCategory eq '탁주'}">selected</c:if>>탁주
                                        </option>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <option value="약"
                                                <c:if test="${pdata.pSour eq '약'}">selected</c:if>>약
                                        </option>
                                        <option value="중"
                                                <c:if test="${pdata.pSour eq '중'}">selected</c:if>>중
                                        </option>
                                        <option value="강"
                                                <c:if test="${pdata.pSour eq '강'}">selected</c:if>>강
                                        </option>
                                    </select>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <option value="약"
                                                <c:if test="${pdata.pSweet eq '약'}">selected</c:if>>약
                                        </option>
                                        <option value="중"
                                                <c:if test="${pdata.pSweet eq '중'}">selected</c:if>>중
                                        </option>
                                        <option value="강"
                                                <c:if test="${pdata.pSweet eq '강'}">selected</c:if>>강
                                        </option>
                                    </select>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <option value="약"
                                                <c:if test="${pdata.pSparkle eq '약'}">selected</c:if>>약
                                        </option>
                                        <option value="중"
                                                <c:if test="${pdata.pSparkle eq '중'}">selected</c:if>>중
                                        </option>
                                        <option value="강"
                                                <c:if test="${pdata.pSparkle eq '강'}">selected</c:if>>강
                                        </option>
                                    </select>
                                    </div>
                                </div>
