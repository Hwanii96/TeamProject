                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pName" id="pName" value="${ddata.pName}"
                                   readonly/>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">별점</label>
                            <input type="text" class="form-control" id="bStar" name="bStar" value="${ddata.bStar}"
                                   readonly/>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="bDate" id="bDate" value="${ddata.bDate}"
                                   readonly/>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="basic-default-message">리뷰 내용</label>
                            <textarea id="basic-default-message" class="form-control"
                                      readonly>${ddata.bContent}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="dmID" id="dmID" value="${ddata.dmID}"
                                   readonly/>
                        </div>
                        ㅋ
                        <div class="mb-3">
                            <label class="form-label">신고날짜</label>
                            <input type="text" class="form-control" name="dDate" id="dDate" value="${ddata.dDate}"
                                   readonly/>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel2">해당 리뷰를 삭제하시겠습니까?</h5>
                                        <button
                                                type="button"
                                                class="btn-close"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="adminReviewDelete.do" method="post">
                                            <input type="hidden" name="dNum" value="${ddata.dNum}">
                                            <input type="hidden" name="bNum" value="${ddata.bNum}">
