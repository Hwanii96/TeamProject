                    ...
                    <section style="width: 1000px">
                        ...
                        <div class="side-bar-wrapper">
                            <form action="updatemember.do" method="post" onsubmit="return validateForm();">
                                ...
                                <div>
                                    비밀번호 &nbsp;&nbsp;<input type="password" id="newPassword" name="mpw"
                                                            value="${data.mPW}" required placeholder="변경할 비밀번호 입력"><br>
                                    재확인 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" id="confirmPassword"
                                                                             name="confirmPassword" value="${data.mPW}"
                                                                             required placeholder="비밀번호 확인"><br>
