            ...
            <div class="search-bar">
                ...
                <script>
                    function search() {
                        ...
                        let newURL = 'search.do?pname=' + encodeURIComponent(searchValue);
            ...
            success: function (pdatas) {
                ...
                if (pdatas.length < 24) {
                    ...
                    for (let i = 0; i < pdatas.length; i++) {
                        let product = pdatas;
                        let productID = product[i].pNum;
                        let productName = product[i].pName;

                        console.log('productName : ' + productName);

                        // 상품 정보를 화면에 표시
                        searchResults.append
                        ("<p><a href='#' data-product-id='" + productID + "'>" + productName + "</a></p>");
                    }
                }
            },
